...
$magicWords['ps'] = [
	'expr' => [ 0, 'څرگندول' ],
	'if' => [ 0, 'که' ],
	'ifeq' => [ 0, 'که‌مساوي', 'که_مساوي' ],
	'ifexpr' => [ 0, 'که‌څرگندول', 'که_څرگندول' ],
	'iferror' => [ 0, 'که‌تېروتنه', 'که_تېروتنه' ],
	'switch' => [ 0, 'ټاکنه', 'بدلول' ],
	'default' => [ 0, '#تلوالیز', '#تلواله' ],
	'ifexist' => [ 0, 'که‌وي', 'که_وي' ],
	'time' => [ 0, 'وخت' ],
	'timel' => [ 0, 'وخت‌اوږدوالی', 'وخت_اوږدوالی' ],
	'rel2abs' => [ 0, 'د‌مطلق‌په‌پرتله', 'د_مطلق_په_پرتله' ],
	'titleparts' => [ 0, 'سرليک‌برخې', 'سرليک_برخې' ],
	'len' => [ 0, 'اوږدوالی' ],
	'pos' => [ 0, 'ځای' ],
	'rpos' => [ 0, 'شاگرځ‌ځای', 'شاگرځ_ځای' ],
	'sub' => [ 0, 'څېرمه' ],
	'count' => [ 0, 'شمېرل', 'شمېر' ],
	'replace' => [ 0, 'ځايناستول' ],
	'explode' => [ 0, 'وېشل', 'غځول' ],
	'urldecode' => [ 0, 'بې‌کوډوېبتړ', 'بې_کوډ_وېبتړ' ],
];
