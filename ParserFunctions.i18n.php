...
'nl' => array(
	...
	'pfunc_expr_stack_exhausted' => 'Fout in expressie: stack uitgeput',
	'pfunc_expr_unexpected_number' => 'Fout in expressie: onverwacht getal',
	'pfunc_expr_preg_match_failure' => 'Fout in expressie: onverwacht falen van preg_match',
	'pfunc_expr_unrecognised_word' => 'Fout in expressie: woord "$1" niet herkend',
	'pfunc_expr_unexpected_operator' => 'Fout in expressie: niet verwachte operator $1',
	'pfunc_expr_missing_operand' => 'Fout in expressie: operand voor $1 mist',
	'pfunc_expr_unexpected_closing_bracket' => 'Fout in expressie: haakje sluiten op onverwachte plaats',
	'pfunc_expr_unrecognised_punctuation' => 'Fout in expressie: niet herkend leesteken "$1"',
	'pfunc_expr_unclosed_bracket' => 'Fout in expressie: niet gesloten haakje openen',
	'pfunc_expr_division_by_zero' => 'Deling door nul',
	'pfunc_expr_unknown_error' => 'Fout in expressie: onbekende fout ($1)',
